...
import com.chuck.paginationscrollview.view.ButtonDropTarget;
...
public class FlingAnimation implements AnimatorUpdateListener, Runnable {
    ...
    public FlingAnimation(DropTarget.DragObject d, PointF vel, ButtonDropTarget dropTarget, PaginationScrollView paginationScrollView) {

...
public abstract class ButtonDropTarget extends TextView
    ...
    protected final PaginationScrollView mPaginationScrollView;
...
//    }
    ...
    public boolean isDropEnabled() {
        return mActive && (mAccessibleDrag ||
                mPaginationScrollView.getDragController().getDistanceDragged() >= mDragDistanceThreshold);
    }
    ...
    public void onDrop(final DragObject d, final DragOptions options) {
        final DragLayer dragLayer = mPaginationScrollView.getDragLayer();
...
//            mLauncher.getStateManager().goToState(NORMAL);
    ...
    public void getHitRectRelativeToDragLayer(Rect outRect) {
        ...
        mPaginationScrollView.getDragLayer().getDescendantCoordRelativeToSelf(this, sTempCords);
